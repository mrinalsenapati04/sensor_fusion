...
def project_velo_to_cam2(calib):
     # velo2ref_cam
    P_velo2cam_ref=np.vstack((calib['Tr_velo_to_cam'].reshape(3, 4), np.array([0., 0., 0., 1.]))) 
    # print('shape of P_velo2cam_ref ',P_velo2cam_ref.shape)
    R_ref2rect = np.eye(4)
    R0_rect = calib['R0_rect'].reshape(3, 3)  # ref_cam2rect
    R_ref2rect[:3, :3] = R0_rect
    # print('shape of R_ref2rect ',R_ref2rect.shape)
    
    P_rect2cam2 = calib['P2'].reshape((3, 4))
    # print('shape of P_rect2cam2 ',P_rect2cam2.shape)
    
    proj_mat = P_rect2cam2 @ R_ref2rect @ P_velo2cam_ref
    # print('shape of proj_mat ',proj_mat.shape)
    return proj_mat
...
def project_to_image(points, proj_mat):
    ...
    # print('points shape after 1 addition is ',points.shape)
    # print(points)
    # print('project matrix is', proj_mat)
    points = proj_mat @ points
    # print('points after projection shape is ',points.shape)
    points[:2, :] /= points[2, :]
    return points[:2, :]
